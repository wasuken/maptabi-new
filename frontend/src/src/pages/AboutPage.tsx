...
import { MapPin, Github, Mail, ExternalLink, BookOpen, Globe, PlusCircle, Lock } from 'lucide-react';
...
<section className="space-y-4">
          ...
          <ul className="space-y-3 mt-4">
            <li className="flex items-center text-gray-700">
              ...
              <span>メール: </span>
              <a href={`mailto:${import.meta.env.VITE_SUPPORT_EMAIL || 'support@maptabi.example.com'}`} className="ml-1 text-blue-600 hover:underline">
            ...
            <li className="flex items-center text-gray-700">
              ...
              <a 
                href={import.meta.env.VITE_CONTACT_FORM_URL || 'https://maptabi.example.com/contact'} 
                target="_blank" 
                rel="noopener noreferrer" 
