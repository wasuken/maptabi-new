  ...
  return (
    <div className={`bg-white rounded-lg shadow-lg p-4 ${className}`}>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
        ...
        <div className="flex items-center">
          <div className="w-6 h-6 bg-blue-500 rounded-full mr-3 flex items-center justify-center text-white text-xs font-bold flex-shrink-0">
            2
          </div>
          <div>
        ...
        <div className="flex items-center">
          <div className="w-6 h-6 bg-blue-500 rounded-sm mr-3 flex items-center justify-center text-white text-xs font-bold flex-shrink-0">
            E
          </div>
          <div>
